...
public class GetAllFirewallQueryHandler  : IRequestHandler<GetAllFirewallQuery, List<GetAllFirewallQueryResult>>
{
    private readonly IAssetRepository _assetRepository;

    public GetAllFirewallQueryHandler(IAssetRepository assetRepository)
    {
